...
- **IP Classification** - Identify IP classes (A, B, C, D, E)
- **Private/Public Detection** - Determine if IP is private or public
- **Default Subnet Mask** - Calculate default mask based on IP class
- **Binary Mask Conversion** - Convert subnet masks to binary format
...
```bash
git clone https://github.com/yourusername/ip-address-analyzer.git
